...
export const EmailChangeEmail = ({
  ...
  <Html lang="pt-BR" dir="ltr">
    <Head />
    <Preview>Confirme a alteração do seu email na NutriLeague</Preview>
    <Body style={main}>
      <Container style={container}>
        <Heading style={brand}>NutriLeague</Heading>
        <Heading style={h1}>Confirme a alteração de email</Heading>
        <Text style={text}>
          Você solicitou alterar o email da sua conta na NutriLeague de{' '}
        ...
        <Text style={footer}>
          Se você não solicitou essa mudança, proteja sua conta imediatamente.
        </Text>
      </Container>
    </Body>
  </Html>
